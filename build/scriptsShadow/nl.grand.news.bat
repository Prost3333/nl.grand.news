...
set CLASSPATH=%APP_HOME%\lib\nl.grand.news-1.0-SNAPSHOT-all.jar

@rem Execute nl.grand.news
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %NL_GRAND_NEWS_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%NL_GRAND_NEWS_EXIT_CONSOLE%" exit 1
exit /b 1
